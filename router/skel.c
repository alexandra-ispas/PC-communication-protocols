...
/*    Functia poate fi folosita pentru ICMP Time Limit Excedeed si 
		ICMP Destination Unreachable.*/

void send_icmp_error(uint32_t daddr, uint32_t saddr, uint8_t *sha, uint8_t *dha, 
		u_int8_t type, u_int8_t code, int interface){
...
void send_arp(uint32_t daddr, uint32_t saddr, struct ether_header *eth_hdr, 
